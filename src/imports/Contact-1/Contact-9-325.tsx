import svgPaths from "./svg-9jsdd6ri6d";
...
import { imgGroup } from "./svg-kzefj";
...
function Group6() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[569px] not-italic text-[13px] text-black top-[27px] whitespace-nowrap">Explore Courses</p>
      ...
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[943px] not-italic text-[#4c7fd2] text-[13px] top-[27px] w-[71px]">Contact Us</p>
...
export default function Contact() {
  return (
    <div className="bg-white relative size-full" data-name="contact">
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[291px] not-italic text-[16px] text-white top-[542px] whitespace-nowrap">info@analytixlabs.co.in</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[291px] not-italic text-[16px] text-white top-[667px] whitespace-nowrap">+91 95552 19007</p>
      ...
      <div className="absolute h-[191px] left-[75px] rounded-bl-[15px] rounded-br-[15px] shadow-[0px_4px_10px_0px_rgba(0,0,0,0.15)] top-[1477px] w-[411px]" data-name="map">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-bl-[15px] rounded-br-[15px] size-full" src={imgMap} />
      </div>
      <div className="absolute h-[191px] left-[514px] rounded-bl-[15px] rounded-br-[15px] shadow-[0px_4px_10px_0px_rgba(0,0,0,0.15)] top-[1477px] w-[412px]" data-name="map">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-bl-[15px] rounded-br-[15px] size-full" src={imgMap1} />
      </div>
      <div className="absolute h-[191px] left-[954px] rounded-bl-[15px] rounded-br-[15px] shadow-[0px_4px_10px_0px_rgba(0,0,0,0.15)] top-[1477px] w-[412px]" data-name="map">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-bl-[15px] rounded-br-[15px] size-full" src={imgMap2} />
      </div>
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[114px] not-italic text-[#09263f] text-[24px] top-[1206px] whitespace-nowrap">Noida</p>
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[554px] not-italic text-[#09263f] text-[24px] top-[1206px] whitespace-nowrap">Gurgaon</p>
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[994px] not-italic text-[#09263f] text-[24px] top-[1206px] whitespace-nowrap">Bengaluru</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[164px] not-italic text-[16px] text-[rgba(9,38,63,0.5)] top-[1259px] w-[289px]">1st Floor, A78, A Block, Sector 2, Metro Gate 3, Noida, UP 201301.</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[604px] not-italic text-[16px] text-[rgba(9,38,63,0.5)] top-[1259px] w-[289px]">Sidhartha House, 2nd Floor, Plot 6, near HUDA City Metro, Sector 44, Gurugram, Haryana 122003</p>
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[164px] not-italic text-[16px] text-[rgba(9,38,63,0.5)] top-[1347px] w-[289px]">+91 95552 19007</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[604px] not-italic text-[16px] text-[rgba(9,38,63,0.5)] top-[1347px] w-[289px]">+91 95552 19007</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[1044px] not-italic text-[16px] text-[rgba(9,38,63,0.5)] top-[1347px] w-[289px]">+91 95552 19007</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[164px] not-italic text-[16px] text-[rgba(9,38,63,0.5)] top-[1424px] w-[289px]">10:00 AM to 07:00 PM</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[604px] not-italic text-[16px] text-[rgba(9,38,63,0.5)] top-[1424px] w-[289px]">10:00 AM to 07:00 PM</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[1044px] not-italic text-[16px] text-[rgba(9,38,63,0.5)] top-[1424px] w-[289px]">10:00 AM to 07:00 PM</p>
